...
windo.title("Handwritten Character Recognition")
model = load_model("C:/Users/91812/OneDrive/Desktop/HCR/model.h5")
...
def pred_digit():
    ...
    pred =  np.argmax(res)
    acc = max(res)
    no = tk.Label(windo, text='Predicted Digit is: '+str(pred), width=34, height=1, fg="white", bg="midnightblue", font=('times', 16, ' bold '))
    no.place(x=400, y=380)
